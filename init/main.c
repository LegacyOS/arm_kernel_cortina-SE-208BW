 ...
 */
	...
	////////////////////////////////////////////////////////////////////// ASTEL 121210
	reg = readl(IO_ADDRESS(SL2312_GLOBAL_BASE)+0x10);
	reg |= 0x00c00000;			// PCI & IDE Driving Capa: 8mA(5)->16mA(f)
	writel(reg, IO_ADDRESS(SL2312_GLOBAL_BASE)+0x10);

	reg = readl(IO_ADDRESS(SL2312_GLOBAL_BASE)+0x14);
	reg |= 0x00000080;			// PCI Skew Rate: Fast->Slow
	writel(reg, IO_ADDRESS(SL2312_GLOBAL_BASE)+0x14);
	////////////////////////////////////////////////////////////////////// ASTEL 121210
