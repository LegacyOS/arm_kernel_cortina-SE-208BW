#ifndef __STORM_SSP_H__
#define __STORM_SSP_H__
...
#define SSP_I2S_DEC_LEVEL			_IOW  ('q', 0x5, int)
#define SSP_I2S_SETFMT				_IOW  ('q', 0x6, int)
#define SSP_I2S_STEREO				_IOW  ('q', 0x7, int)
#define SSP_I2S_SETSPEED				_IOW  ('q', 0x8, int) //48000 44100
#define SSP_I2S_SETCHANNELS				_IOW  ('q', 0x9, int)

//#define SSP_I2S_DEC_LEVEL			_IOW  ('q', 0x5, int)
//#define SSP_I2S_DEC_LEVEL			_IOW  ('q', 0x5, int)

#endif //__STORM_SSP_H__
