...
{IO_ADDRESS(SL2312_TVE_BASE),          __phys_to_pfn(SL2312_TVE_BASE),         SZ_512K,  MT_DEVICE}, 
#ifdef CONFIG_MTD_NAND_SL2312
{FLASH_VADDR(SL2312_FLASH_BASE),       __phys_to_pfn(SL2312_FLASH_BASE),       SZ_64M,    MT_DEVICE},
#else
/* flash dirver will remap io space, we should not double map here */
//{FLASH_VADDR(SL2312_FLASH_BASE),       __phys_to_pfn(SL2312_FLASH_BASE),       SZ_16M,    MT_DEVICE},
#endif
#ifdef CONFIG_GEMINI_IPI
{IO_ADDRESS(0x7f00000),         __phys_to_pfn(0x7f00000),   SZ_1M,  MT_DEVICE}, 
#endif
};
