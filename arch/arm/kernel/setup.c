...
EXPORT_SYMBOL(astel_serial_RS485);
...
void __init setup_arch(char **cmdline_p)
{
	...
	if (mdesc->fixup)
		mdesc->fixup(mdesc, tags, &from, &meminfo);			// sl2312_fixup() dhsul ASTEL
	...
	rs485_mode = readl(CORTINA_GPIO_0_DATA_IN) & 0x80000000;			// GPIO0_31
	if (rs485_mode)
	{
		printk("ASTEL Serial Mode: RS485\n");
		astel_serial_RS485 = 1;
	}
	else
	{
		printk("ASTEL Serial Mode: RS232\n");
