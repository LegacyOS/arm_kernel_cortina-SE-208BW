...
"$Header: /auto/project/cvsroot-sw/gemini-2.6.15/drivers/net/sk98lin/skgeasf.c,v 1.1 2008/03/25 09:52:24 jason Exp $" ;
#endif
	...
	case SK_INIT_IO:
		...
		if (fw_read(pAC,FwFileNameS1,&pAsfFwS1,&FileLengthS1) && 
			...
			if( (pAC->AsfData.FileFwVersion[1] == pAC->AsfData.DriverVersion[1]) &&
				...
				if (YukonEcA1)  {  // was if (pAC->GIni.GIChipRev == CHIP_REV_YU_EC_A1) before
				...
				SK_DBG_MSG(pAC, SK_DBGMOD_ASF, SK_DBGCAT_CTRL,("    Flash found with size of %d\n", FlashSize));
