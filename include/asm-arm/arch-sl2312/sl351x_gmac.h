...
#define GMAC_NUM					1				/* 111228-dhsul-lt: 2 -> 1 */
#define GMAC_VNUM					2				/* 111228-dhsul-lt: 가상 숫자 */
...
// IPsec VPN requires slightly larger buffer size
...
#define TOE_GMAC0_SWTXQ_DESC_POWER	10
...
#define TOE_GMAC1_SWTXQ_DESC_POWER	10
...
#define TOE_SW_FREEQ_DESC_POWER		10
#define TOE_SW_FREEQ_DESC_NUM		(1<<TOE_SW_FREEQ_DESC_POWER)
#define TOE_HW_FREEQ_DESC_POWER		10
#define TOE_HW_FREEQ_DESC_NUM		(1<<TOE_HW_FREEQ_DESC_POWER)
#define TOE_GMAC0_SWTXQ_DESC_POWER	10
#define TOE_GMAC0_SWTXQ_DESC_NUM	(1<<TOE_GMAC0_SWTXQ_DESC_POWER)
#define TOE_GMAC0_HWTXQ_DESC_POWER	10
#define TOE_GMAC0_HWTXQ_DESC_NUM	(1<<TOE_GMAC0_HWTXQ_DESC_POWER)
#define TOE_GMAC1_SWTXQ_DESC_POWER	10
#define TOE_GMAC1_SWTXQ_DESC_NUM	(1<<TOE_GMAC1_SWTXQ_DESC_POWER)
#define TOE_GMAC1_HWTXQ_DESC_POWER	10
#define TOE_GMAC1_HWTXQ_DESC_NUM	(1<<TOE_GMAC1_HWTXQ_DESC_POWER)
#define TOE_DEFAULT_Q0_DESC_POWER	12
#define TOE_DEFAULT_Q0_DESC_NUM		(1<<TOE_DEFAULT_Q0_DESC_POWER)
#define TOE_DEFAULT_Q1_DESC_POWER	12
#define TOE_DEFAULT_Q1_DESC_NUM		(1<<TOE_DEFAULT_Q1_DESC_POWER)
#define TOE_TOE_DESC_POWER			8
#define TOE_TOE_DESC_NUM			(1<<TOE_TOE_DESC_POWER)
#define TOE_CLASS_DESC_POWER		10
...
#define TOE_SW_TXQ_NUM				3	//axl20090211
...
//	unsigned int		intr4_enabled_1;	// 1: enabled
	...
	unsigned long		txDerr_cnt[GMAC_VNUM];			/* 111228-dhsul-lt: GMAC_NUM -> GMAC_VNUM */
	unsigned long		txPerr_cnt[GMAC_VNUM];			/* 111228-dhsul-lt: GMAC_NUM -> GMAC_VNUM */
	unsigned long		RxDerr_cnt[GMAC_VNUM];			/* 111228-dhsul-lt: GMAC_NUM -> GMAC_VNUM */
	unsigned long		RxPerr_cnt[GMAC_VNUM];			/* 111228-dhsul-lt: GMAC_NUM -> GMAC_VNUM */
...
//	unsigned int	intr_buf_base;
	...
	GMAC_INFO_T		gmac[GMAC_VNUM];			/* 111228-dhsul-lt: GMAC_NUM -> GMAC_VNUM */
