...
#define HASH_OCCUPIED   4999	// special handle value
/*----------------------------------------------------------------------
 *  special macro
 ----------------------------------------------------------------------*/
...
#define IGMP_KEY_DWORD_SIZE	(sizeof(IGMP_KEY_T)/sizeof(u32))
#define IGMP_KEY_SIZE		(sizeof(IGMP_KEY_T))
...
typedef struct {
	...
	u16		vlan_id;		//add for vlan
	u16		pppoe_sid;		//add for vlan
#endif
	u8		ip_protocol;
	u8		reserved1;		// ip_tos, not used
	u16		reserved2;		// not used
...
#define NAT_KEY0_DWORD_SIZE	(sizeof(NAT_KEY0_T)/sizeof(u32))
#define NAT_KEY0_SIZE		(sizeof(NAT_KEY0_T))
...
#define IPSEC_KEY_DWORD_SIZE	(sizeof(IPSEC_KEY_T)/sizeof(u32))
#define IPSEC_KEY_SIZE		(sizeof(IPSEC_KEY_T))
...
#define BR__ACTION_BITS			(ACTION_SRCE_QID_BIT  | ACTION_SA_BIT | ACTION_DA_BIT)

#define IGMP_ACTION_BITS		(ACTION_SRCE_QID_BIT | ACTION_EXCEPTION_BIT |	\
								ACTION_TTL_1_BIT | ACTION_TTL_0_BIT | 			\
								ACTION_IP_OPTION)
								
#define IGMP_PPPOE_ACTION_BITS	(IGMP_ACTION_BITS | ACTION_PPPOE_INS_BIT)
...
#define NAT_LAN2DMZ_ACTIONS		(NAT_ACTION_BITS | ACTION_DIP_BIT | ACTION_SPORT_BIT)
#define NAT_LAN2WAN_DMZ_ACTIONS	(NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_SPORT_BIT | ACTION_VLAN_DEL_BIT)
#define NAT_WAN2LAN_ACTIONS		(NAT_ACTION_BITS | ACTION_DIP_BIT | ACTION_DPORT_BIT)
#define NAT_DMZ2LAN_ACTIONS		(NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_DPORT_BIT)
#define NAT_WAN2LAN_DMZ_ACTIONS		(NAT_ACTION_BITS | ACTION_DIP_BIT | ACTION_DPORT_BIT | ACTION_VLAN_INS_BIT)
#define NAT_PPPOE_LAN2WAN_ACTIONS	(NAT_LAN2WAN_ACTIONS | ACTION_PPPOE_INS_BIT)
#define NAT_PPPOE_LAN2WAN_DMZ_ACTIONS	(NAT_LAN2WAN_DMZ_ACTIONS | ACTION_PPPOE_INS_BIT)
#define NAT_PPPOE_LAN2DMZ_ACTIONS	(NAT_LAN2DMZ_ACTIONS | ACTION_PPPOE_INS_BIT)
#define NAT_PPPOE_WAN2LAN_ACTIONS	(NAT_WAN2LAN_ACTIONS | ACTION_PPPOE_DEL_BIT)
#define NAT_PPPOE_DMZ2LAN_ACTIONS	(NAT_DMZ2LAN_ACTIONS | ACTION_PPPOE_DEL_BIT)
#define NAT_PPPOE_WAN2LAN_DMZ_ACTIONS	(NAT_WAN2LAN_DMZ_ACTIONS| ACTION_PPPOE_DEL_BIT)
...
#define NAT_LAN2WAN_FW_DMZ_ACTIONS		(NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_DIP_BIT | ACTION_SPORT_BIT)
#define NAT_DMZ2WAN_FW_LAN_ACTIONS		(NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_DIP_BIT | ACTION_DPORT_BIT)
...
/*----------------------------------------------------------------------
 *  IGMP NAT Hash Entry for TCP/UDP protocol
 ----------------------------------------------------------------------*/
typedef struct {
	IGMP_KEY_T			key;
	union {
...
#define IGMP_HASH_ENTRY_SIZE	(sizeof(IGMP_HASH_ENTRY_T))
...
/*----------------------------------------------------------------------
 *  NAT/IGMP Hash Entry for TCP/UDP protocol
 ----------------------------------------------------------------------*/
typedef struct {
	NAT_KEY0_T			key;
	union {
...
#define NAT_0_HASH_ENTRY_SIZE		(sizeof(NAT_0_HASH_ENTRY_T))

/*----------------------------------------------------------------------
 *  BRIDGE Hash Entry for TCP/UDP protocol
 ----------------------------------------------------------------------*/
typedef struct {
	u8					active;
	u8					portid;
	u8					mac_addr[6];
	int					my_hash_index;	// -1 if not used
	HASH_TIMEOUT_T		tmo;
} BR_ENTRY_T;
...
/*----------------------------------------------------------------------
 *  IPsec Hash Entry for ESP/AH protocol
 ----------------------------------------------------------------------*/
typedef struct {
	IPSEC_KEY_T			key;
	union {
...
#define IPSEC_HASH_ENTRY_SIZE		(sizeof(IPSEC_HASH_ENTRY_T))
